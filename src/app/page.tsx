...
export default function Homepage() {
    ...
    return (
        ...
        <div className="bg-cover bg-center pt-24 pb-20 px-52" style={{ backgroundImage: 'url(./Login/Bg.svg)' }}>
            <h2 className="text-4xl font-bold text-center">Welcome To <span className="text-[#4B50F7]">Heber Dashboard</span></h2>
            <div className="flex pt-12 gap-24 ">
                <div className="backdrop-blur shadow-lg border-[#ffffff]/20 border-r-2 border-b-2 bg-gradient-to-b from-[#4B50F7]/20 from-0% via-[#4B50F7]/10 to-[#4B50F7]/20 to-100% bg-gradient-to-r from-[#4B50F7]/20 from-0% via-[#4B50F7]/10 to-[#4B50F7]/20 to-100% w-[30vw] py-32 px-10 rounded-[2.5rem] text-center">
                    ...
                    <button className="bg-[#4B50F7] rounded-lg text-white px-6 py-2 mt-4 mx-1" type="submit" onClick={() => { Login(name, password) }}>Log In</button>
